...
const NAV_STRUCTURE = [
  ...
  { type: "item",   path: "/dashboard",       label: "Tableau de bord",        icon: <DashboardIcon />,     alwaysEnabled: true },

  {
    type: "parent", path: "/sessions",         label: "Sessions",               icon: <SessionsIcon />,      alwaysEnabled: true,
    children: [
  ...
  {
    type: "parent", path: "/orders",           label: "Commandes",              icon: <OrdersIcon />,        alwaysEnabled: true,
    children: [
